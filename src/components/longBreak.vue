<template>
    <div :class="{ 'darkMode-items': darkMode }"
        class="long-break long-break-color w-11/12 md:w-5/12  py-32 cursor-default">
        <div
        ...
        <div :class="{ 'hidden': showDropdown }" class="dropdown long-break-color">
            <drop-down :darkMode="darkMode" :svgColor="'#153047'" @showModal="showModal"></drop-down>
        </div>
