<template>
    <div :class="{ 'darkMode-items': darkMode }" class="focus-color focus w-11/12 md:w-5/12 py-32 cursor-default">
        ...
        <div :class="{ 'hidden': showDropdown }" class="dropdown focus-color">
            <drop-down :darkMode="darkMode" @showModal="showModal" :svgColor="'#471515'"></drop-down>
        </div>
        ...
        <div :class="{ 'pointer-events-none': closeBtn !== 1 }" class="flex items-center space-x-3 mt-3 z-10">
            ...
            <button @click="runOrpauseTimer" class="focus-play-btn w-20 h-16 rounded-2xl flex items-center justify-center">
...
export default {
    ...
    data() {
        return {
            ...
            focusTimeValue: localStorage.getItem('focusTime'),
            seconds: 0,
            showSeconds: 0,
            intervalId: null,
            isIconChanged: true,
    ...
    methods: {
        ...
        handleDocumentClick(event) {
            ...
            if (localStorage.getItem('focusTime') !== this.focusTimeValue) {
                this.focusTimeValue = localStorage.getItem('focusTime')
                this.focusTime = localStorage.getItem('focusTime')
                this.seconds = this.focusTime * 60
